package kr.or.test;
/**
 * 이 클래스는 메서드 기반의 Step1 클래스를 객체기반의 클래스로 변경한 클래스.
 * @author User
 *
 */
class MemberVO {
	...
	//하나씩 출력하기힘들때 자동으로 멤버 변수값을 출력하는 명령 toString생성(아래)
	@Override
	...
	// String 을 반환(return) = 겟 메서드 입니다.(아래)
	public String getPhoneNum() {
		return phoneNum;
	}
	// void한(반환값이 없이) 입력하는 셋 메서드 입니다.(아래)
	public void setPhoneNum(String phoneNum) {
		this.phoneNum = phoneNum; // 프라이빗 변수를 직접 접근을 못하니까 
		//퍼블릭 메서드로 입력하게 만들어놓은 구조입니다.
	}
}
public class Step2 {
//step 2 뒤에  "extends Object" 가 생략되어있음
	public static void main(String[] args) {
		// MemberVO클래스 자료형(회원정보) 객체를 생성합니다.(아래)
