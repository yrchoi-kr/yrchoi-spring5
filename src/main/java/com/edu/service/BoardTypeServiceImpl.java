...
public class BoardTypeServiceImpl implements IF_BoardTypeService{
	...
	public BoardTypeVO readBoardType(String board_type) throws Exception {
		// TODO 실행결과반환 readBoardType(아래실행에 필요한변수=매개변수,파라미터,인자,아규먼트)
