              ...
              <form name="form_write", method="post" action="/admin/bbs_type/bbs_type_update" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <!-- PK 고유키, 식별자는 수정할 수 있으면, 여기 묶여있는 하위 게시물들은 소속 잃어버립니다. 그래서 수정 불가 -->
                  ...
                  <div class="form-group">
                    ...
                    <input value="${boardTypeVO.board_sun}" name="board_sun" type="text" class="form-control" id="board_sun" placeholder="출력순서를 입력해주세요">
                  </div>
				</div>
                <!-- /.card-body -->
