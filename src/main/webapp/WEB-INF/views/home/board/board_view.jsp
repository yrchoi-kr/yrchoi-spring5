...
<%@ include file="../include/header.jsp" %>
  <!-- 메인콘텐츠 영역 -->
			...
			<div class="row" style="margin: 0;">
							...
							<div class="bs-stepper-content">
							  ...
							  <div id="logins-part" class="content active dstepper-block" role="tabpanel" aria-labelledby="logins-part-trigger">
								<div class="form-group">
								  ...
								  <input readonly value="${session_userid }" type="text" class="form-control" id="replyer" placeholder="이름 혹은 닉네임을 입력해주세요.">
								</div>
								<div class="form-group">
				...
				<div class="timeline" >
					...
					<div class="time-label">
						<span class="" data-toggle="collapse" href="#collapseReply" role="button" id="btn_reply_list">
						댓글 리스트
						[<span id="reply_count">${empty boardVO.reply_count?'0':boardVO.reply_count}</span>]</span>
					</div>
					<!-- 콜랩스 시작 -->
	...
	<!-- //메인콘텐츠 영역 -->
<!-- 모달창(초기에는 숨김 - 수정버튼 클릭하면 나타나는 창) modal은 display:none, fade는 opacity:0-->
