  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="card-body p-0">
            ...
            <c:forEach var="memberVO" items="${latestMembers}">
              <li style="cursor: pointer;" onclick="location.replace('/admin/member/member_view?user_id=${memberVO.user_id}&page=1')">
                ...
                <!-- onerror는 엑박일때 대신 보여줄 이미지를 지정 -->
                <img style="width:150px; height:150px;" onerror="this.src='/resources/admin/dist/img/default-150x150.png'" src="/resources/profile/${memberVO.user_id}.jpg">
        ...
        <!-- include와 import의 차이점: include는 소스를 조립후 컴파일, import는 개발파일을 컴파일 후 조립 -->
