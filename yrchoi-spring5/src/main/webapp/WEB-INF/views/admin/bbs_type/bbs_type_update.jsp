            ...
            <form name="form_write" method="post" action="/admin/bbs_type/bbs_type_update" enctype="multipart/form-data">
              <div class="card-body">
                <div class="form-group">
                  <!-- PK고유키, 식별자는 수정할 수 있으면, 여기에 묶여있는 겔러리 가반의 게시판이 주인을잃어버림 -->
                  <label for="board_type">게시판타입</label>
                  <input readonly value="${boardTypeVO.board_type}" name="board_type" type="text" class="form-control" id="board_type" placeholder="게시판 타입을 입력해 주세요" required>
                </div>
                <div class="form-group">
                  <label for="content">게시판이름</label>
                  <input value="${boardTypeVO.board_name}" name="board_name" type="text" id="board_name" class="form-control" placeholder="게시판명을 입력해주세요." required></input>
                </div>
                <div class="form-group">
