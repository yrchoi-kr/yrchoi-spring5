...
var replyList = function() {
	...
	$.ajax({
		...
		error:function(result) {
			//console.log(result);//크롬에서 확인 가능할 때,
			//전체 json데이터를 출력할떄 stringify함수로 형변환해서 출력
			//alert(JSON.stringify(result));//이클립스에서 확인 할 때
			//만약 json데이터에서 키 이름을 알게되면, stringfy함수 필요없이 result.responseText출력가능
